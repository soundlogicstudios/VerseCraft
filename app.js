/* VerseCraft Demo App
   - Fixes reserved choice targets: INVENTORY / CHARACTER / SAVE / LOAD / MENU
   - Restores HUD buttons (Character / Inventory / Save / Load / Main Menu)
   - Story title shown in HUD (current loaded module)
   - Menu uses logo: assets/versecraft-logo.png
*/
...
(function () {
        ...
        e("div", { className: "hudBars" }, [
          e("div", { className: "barRow" }, [
            ...
            e("div", { className: "barTrack" }, [
              e("div", { className: "barFill hp", style: { width: `${maxHp ? Math.round((hp / maxHp) * 100) : 0}%` } })
            ]),
          ...
          e("div", { className: "barRow" }, [
            ...
            e("div", { className: "barTrack" }, [
              e("div", { className: "barFill xp", style: { width: `${clamp((xp / 100) * 100, 0, 100)}%` } })
            ]),
  ...
  function CharacterSheet({ state, itemIndex, onClose }) {
    ...
    const eq = ensureEquippedShape(state.equipped);
    const labelOf = (id) => itemIndex[id]?.title || id || "None";
  ...
  function InventoryModal({ state, itemIndex, onUse, onEquip, onClose }) {
    ...
    const listForTab = () => (
      ...
      tab === "Weapons" ? inv.weapons :
      tab === "Armor" ? inv.armors :
      inv.specialItems
    );
    ...
    return e("div", { className: "menuScene" }, [
      e("div", { className: "menuFrame" }, [
        e("div", { className: "menuLogoWrap" }, [
          e("img", { className: "menuLogo", src: LOGO_SRC, alt: "VerseCraft Logo" })
        ]),
        e("div", { className: "menuSubtitle" }, "Choose Your Paths. Live Your Story."),
        e("button", { className: "btn btnPrimaryWide", onClick: () => onStartStory(defaultId), disabled: !defaultId }, "Tap To Start"),
        ...
        e("div", { className: "menuDivider" }),
        e("button", { className: "btn btnGhostWide", onClick: onLoadSave, disabled: !hasSave }, "Load Saved Game")
      ])
    ]);
  }
  ...
  function App() {
    ...
    function handleReservedTarget(toRaw) {
      ...
      if (to === "SAVE") { onSave(); return true; }
      if (to === "LOAD") { onLoad(); return true; }
      if (to === "MENU" || to === "MAIN_MENU" || to === "MAINMENU") { gotoMenu(); return true; }
    ...
    function onChoose(choice) {
      if (!choice) return;
      if (handleReservedTarget(choice.to)) return;
      ...
      return e("div", { className: "deathScreen" }, [
        e("div", { className: "deathCard" }, [
          ...
          e("div", { className: "deathActions" }, [
            e("button", { className: "btn btnPrimaryWide", onClick: () => loadStoryById(manifest?.defaultStoryId || "lorecraft_tutorial") }, "Restart Tutorial"),
            e("button", { className: "btn btnGhostWide", onClick: () => gotoMenu() }, "Return To Menu")
          ])
        ])
      ]);
    }
  ...
  function mount() {
    ...
    if (!root) { console.error("Missing #app or #root in index.html"); return; }
